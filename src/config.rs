...
pub use self::{
    ...
    model::{
        ...
        IslandDisplayConfig, IslandPositionConfig, NewTerminalCwdConfig, ShellModeConfig,
        SidebarCollapsedModeConfig, TabBarPositionConfig, TabBarStyleConfig,
        ToastClipboardPosition, ToastConfig, ToastDelivery, ToastHerdrPosition,
        UpdateChannelConfig, MAX_TOAST_DELAY_SECONDS,
    },
    sidebar::{
        AgentSidebarToken, AgentsSidebarConfig, AgentsViewConfig, CompactRailLeadingConfig,
        SidebarConfig, SidebarTokenStyle, SpaceSidebarToken, SpacesSidebarConfig,
    },
    sound::SoundConfig,
