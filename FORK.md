...
| `src/server/headless.rs` | Own the embedded watcher, telemetry ingestion, and title-sync lifecycles across normal and handoff server paths, reconcile shared island-panel state from foreground-client geometry, warn about enabled standalone twins, and keep test construction cfg-clean on Windows. | `dd08df50`, `e006a1ea`, `b3aff323`, `95a7db2a`, PR #6, island motion (this commit), island notification arrivals (this commit), island panel geometry reconciliation (this commit) |
